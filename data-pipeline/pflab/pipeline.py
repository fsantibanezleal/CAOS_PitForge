...
the compact artifact + manifest (CONTRACT 2) and a flat index.json.
    ...
    python -m pflab.pipeline            # all cases
    python -m pflab.pipeline EX02_epidemic --seed 7
"""
...
# data-pipeline/pflab/pipeline.py -> parents[2] = repo root (works under `pip install -e .` too)
