...
RNG. Same inputs ⇒ byte-identical artifact (asserted in `tests/test_pipeline_smoke.py`). The committed artifact is
therefore a trustworthy source-of-truth that the SPA merely animates (ADR-0052 / ADR-0054).
