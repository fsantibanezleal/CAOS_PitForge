...
| **`@fasl-work/caos-app-shell`** | the whole app | the shared header/nav/theme/language chrome + the doc-kit (Tabs, Callout, Equation/KaTeX, Figure, Cite), shared across every Faena app so they read as visual siblings. |
