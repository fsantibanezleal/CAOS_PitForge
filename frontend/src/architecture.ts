  ...
  tabs: [
    {
      ...
      body_en:
        ...
        '"what is the most valuable pit that can be dug, respecting the wall angle?". Dragging the price, cost or slope ' +
        'recomputes the optimal pit + the value-vs-tonnage curve live.\n\n' +
    ...
    },
    {
      ...
      body_en:
        ...
        'server. Offline / compute (the local machine, isolated .venv): the Python pipeline bakes the canonical case ' +
      ...
      body_es:
        ...
        'TypeScript (frontend/src/opt/) se re-ejecuta con cada control y onnxruntime-web ejecuta grade-nn.onnx + ' +
        'pit-surrogate.onnx, sin servidor. Offline / cómputo (la máquina local, .venv aislado): el pipeline Python precalcula los ' +
    ...
    },
    {
      ...
      body_en:
        'The App page recomputes live: inputs (the case selector or a user-supplied block model, plus the price, cost and ' +
      ...
      body_es:
        'La página App recalcula en vivo: las entradas (el selector de casos o un modelo de bloques propio, más los ' +
    ...
    },
    {
      ...
      body_es:
        ...
        '(sin heurística); ④ barriendo el factor de ingreso λ se trazan las cáscaras anidadas de Whittle (pit(λ₁) ⊆ ' +
    ...
    },
    {
      ...
      body_en:
        ...
        'guards, so the app accepts supplied data, not just the built-in cases. Contract 2 (artifact) defines the output ' +
      ...
      body_es:
        ...
        'talud, con guardas de rango/NaN, para que la app acepte datos propios, no sólo los casos incluidos. El Contrato 2 ' +
        ...
        'determinista ejecuta el lane gate (numpy-light por defecto, --retrain para el carril pesado de torch) y escribe ' +
