    ...
    <article className="page-body prose">
      ...
      <Callout variant="strong" title={es ? 'El optimizador exacto se ejecuta en vivo en el navegador' : 'The exact optimiser runs live in the browser'}>
        {es
          ...
          : 'The ultimate pit is computed with a max-flow / min-cut solver (Lerchs–Grossmann via Picard’s max-closure reduction) written in TypeScript, the same engine runs in the browser and in the offline bake. Dragging the revenue factor, price or slope re-solves the pit exactly, instantly.'}
      </Callout>
