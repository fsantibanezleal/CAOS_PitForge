// LIVE lane (optional, Pyodide): load the inlined pflab sources (public/pyodide/sources.json) and call
// pflab.live.run_trace_json for a bring-your-own-params interaction in the browser. This is a STUB — a real
