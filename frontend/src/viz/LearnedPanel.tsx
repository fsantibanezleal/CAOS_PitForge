  ...
  return (
    <div className="pf-vizstack">
      <div className="pf-plot-t">{es
        ? `Preview instantáneo del pit (surrogate ONNX) en la sección Y=${iy}, a RF=1 (semántica de entrenamiento), color = P(en pit), contorno = pit exacto a RF=1. Al mover precio/talud se compara; el deslizador RF no afecta este tab.`
